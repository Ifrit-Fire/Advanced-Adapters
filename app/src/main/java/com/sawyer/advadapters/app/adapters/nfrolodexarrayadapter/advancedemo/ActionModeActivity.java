 ...
 * with the rolodex adapter. When using the rolodex adapter, the adapter itself takes ownership of
 * setting choice mode. Setting it on the ExpandableListView itself will cause the app to crash.
 * <p/>
...
public class ActionModeActivity extends ExpandableListActivity {
	...
	/**
	 * When enabling a modal choiceMode, a custom {@link com.sawyer.advadapters.widget.PatchedExpandableListAdapter.ChoiceModeListener}
	 * is required to be set on the adapter. This usage is identical to that of {@link
	 * android.widget.AbsListView.MultiChoiceModeListener} with the difference of having child and
	 * group checked state callbacks.
	 * <p/>
