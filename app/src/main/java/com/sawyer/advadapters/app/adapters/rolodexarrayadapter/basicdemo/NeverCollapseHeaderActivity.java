...
/**
 * Demonstration on how to make a our ExpandableListActivity show as always expanded. This would be
 * the similar look one sees with setting screens. Note, RolodexBaseAdapter's will always auto sort
 * groups.
 */
