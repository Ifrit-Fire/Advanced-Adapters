...
import com.sawyer.advadapters.app.adapters.nfrolodexarrayadapter.PickDemoActivity;
...
public class FullDemoActivity extends AdapterBaseActivity implements
	...
	protected String getInfoDialogMessage() {
		return getString(R.string.info_rolodex_nfarrayadapter_message);
	}

	@Override
	protected String getInfoDialogTitle() {
		return getString(R.string.info_rolodex_nfarrayadapter_title);
	}
