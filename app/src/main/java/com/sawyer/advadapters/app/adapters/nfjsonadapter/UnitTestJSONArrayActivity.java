...
public class UnitTestJSONArrayActivity extends AdapterBaseActivity implements
	...
	protected void reset() {
		...
		adapter.add(
				MovieContent.ITEM_LIST.get(new Random().nextInt(MovieContent.ITEM_LIST.size())));
		adapter.add(new JSONArray(Arrays.asList(getString(), getString(), getString())));
		adapter.add(
				MovieContent.ITEM_JSON.opt(new Random().nextInt(MovieContent.ITEM_JSON.length())));
